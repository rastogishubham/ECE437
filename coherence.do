...
add wave -noupdate -expand -group tbif /memory_control_tb/PROG/tbif/iwait
add wave -noupdate -expand -group tbif /memory_control_tb/PROG/tbif/dwait
add wave -noupdate -expand -group tbif /memory_control_tb/PROG/tbif/iREN
...
add wave -noupdate -expand -group tbif /memory_control_tb/PROG/tbif/iload
...
add wave -noupdate -expand -group tbif /memory_control_tb/PROG/tbif/iaddr
...
add wave -noupdate -expand -group tbif2 /memory_control_tb/PROG/tbif2/iwait
add wave -noupdate -expand -group tbif2 /memory_control_tb/PROG/tbif2/dwait
add wave -noupdate -expand -group tbif2 /memory_control_tb/PROG/tbif2/iREN
...
add wave -noupdate -expand -group tbif2 /memory_control_tb/PROG/tbif2/iload
...
add wave -noupdate -expand -group tbif2 /memory_control_tb/PROG/tbif2/iaddr
...
add wave -noupdate -expand -group ramif /memory_control_tb/ramif/ramREN
add wave -noupdate -expand -group ramif /memory_control_tb/ramif/ramWEN
add wave -noupdate -expand -group ramif /memory_control_tb/ramif/ramaddr
add wave -noupdate -expand -group ramif /memory_control_tb/ramif/ramstore
add wave -noupdate -expand -group ramif /memory_control_tb/ramif/ramload
add wave -noupdate -expand -group ramif /memory_control_tb/ramif/ramstate
...
WaveRestoreCursors {{Cursor 1} {60708 ps} 0}
